...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $basePath; ?>/public/assets/css/partnerHospitals.css">
</head>

<body>
    <div class="hospitals-container">
        <h1>Our Partner Hospitals</h1>
        <p>We proudly partner with Sri Lanka's leading private hospitals to bring you the best in healthcare and medical
            tourism.</p>
