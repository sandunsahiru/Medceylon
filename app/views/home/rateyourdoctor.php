...
<body>
    <link rel="stylesheet" href="<?php echo $basePath; ?>/public/assets/css/rateyourdoctor.css">
    <div class="main-container">
        <div class="rate-container">
            <h1>Rate Your Doctor</h1>
            <p class="intro-text">We value your feedback! Please take a moment to rate your doctor and share your
                experience.</p>
