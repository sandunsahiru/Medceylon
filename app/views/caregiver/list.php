...
<div class="page-wrapper">
    ...
    <p>Age: <?= isset($caregiver['age']) ? htmlspecialchars($caregiver['age']) : 'N/A' ?></p>
    <p>Experience: <?= isset($caregiver['experience_years']) ? htmlspecialchars($caregiver['experience_years']) . ' years' : 'N/A' ?></p>


    <?php if ($caregiver['already_requested']): ?>
        <button class="btn requested-btn" disabled>✅ Request Sent</button>
    <?php else: ?>
        <a href="mailto:<?= htmlspecialchars($caregiver['email']) ?>?subject=Request to be my Caregiver" 
