    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <select name="country_code" id="country_code" required>
                ...
                <?php foreach ($countries as $country): ?>
                    <option value="<?= htmlspecialchars($country['country_code']); ?>"><?= htmlspecialchars($country['country_name']); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <?php if ($country_details): ?>
            <div class="details">
                ...
                <?php else: ?>
                    <p><strong>No visa is required for citizens of <?= htmlspecialchars($country_details['country_name']); ?>.</strong></p>
                <?php endif; ?>
                <p><strong>Embassy Link:</strong> <a href="<?= htmlspecialchars($country_details['embassy_link']); ?>" target="_blank"><?= htmlspecialchars($country_details['embassy_link']); ?></a></p>
            </div>
        <?php endif; ?>
    </div>
